...
\begin{lstlisting}[caption=Utdrag fra \texttt{actionPerformed}-metoden i \texttt{ControllerBunnPanel.java}, label=kode:contbpan]
...
\begin{lstlisting}[caption=Eksempel på hvilke menyvalg som dukker opp ved høyreklikk i tabellen.,label=kode:eks1]
